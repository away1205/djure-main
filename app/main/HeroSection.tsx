  ...
  return (
    ...
    >
      <div className="relative mt-20 flex flex-col overflow-clip">
        ...
        <div className="relative flex flex-col sm:-top-22 sm:right-[28%] sm:ml-auto sm:gap-4 md:right-[28%] xl:right-[22%] xl:gap-[2.5rem]">
      ...
      <div className="sm:hidden">
        <HeroButton fullWidth />
      </div>
    </section>
  );
}

function HeroButton({ fullWidth }: { fullWidth?: boolean }) {
  return (
    <div
